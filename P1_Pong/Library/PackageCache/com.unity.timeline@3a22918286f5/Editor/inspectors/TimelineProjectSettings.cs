...
{
    // needed for 2022.3 Field 'assetDefaultFramerate' has the same name as the [FormerlySerializedAs("assetDefaultFramerate")] argument on another field in this type
    //TODO: remove when 2022.3 is no longer supported.
...
#pragma warning disable 0618
        get
        {
            if (Mathf.Abs((float)m_DefaultFrameRate - assetDefaultFramerate) > Mathf.Epsilon)
            {
