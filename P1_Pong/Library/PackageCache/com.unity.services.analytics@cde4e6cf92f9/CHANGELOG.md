...
* The SDK no longer throws exceptions when there is a problem writing the event cache file to disk

## [6.2.1] - 2026-01-27

### Fixed

* The SDK now saves unsent events to disk during OnApplicationPause, to prevent data loss if the application is then terminated while minimized
...
* The minimum supported editor version for the UGS Analytics SDK is now 2022.3
