...
namespace UnityEditor.Tilemaps
{
    ...
    public class GridPaintingState : ScriptableSingleton<GridPaintingState>
    {
        ...
        [SerializeField] private bool m_ExitingEditMode;
        ...
        private void OnEditDisable()
        {
            ...
            if (!m_ExitingEditMode && PaintableGrid.InGridEditMode())
            {
        ...
        private void HierarchyChanged()
        {
            if (hasInterestedPainters)
            {
                ...
                if (gridBrush == null || validTargets == null || validTargets.Length == 0 || !validTargets.Contains(scenePaintTarget))
                {
        ...
        public static GridBrushPickStore brushPickStore
        {
            ...
            internal set
            {
                ...
                if (instance.m_BrushPickStore != null)
                {
                    if (!AssetDatabase.IsMainAsset(instance.m_BrushPickStore))
